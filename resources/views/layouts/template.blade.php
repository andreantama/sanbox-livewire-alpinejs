...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title> @yield('title') | Alumni Poliwangi </title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			...
			<a href="https://mitrasunatan.com/" style="display:flex; flex-direction:row; justify-content: flex-start; align-items:center;">
				<h1 class="text-white ml-2">POLIWANGI</h1>
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="https://poliwangi.ac.id" class="brand-logo">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a class="text-muted">@yield('title')</a>
											</li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
										<a href="#" class="btn btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<span class="svg-icon svg-icon-success svg-icon-2x">
												<!--begin::Svg Icon | path:assets-admin/media/svg/icons/Files/File-plus.svg-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														<polygon points="0 0 24 0 24 24 0 24" />
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://poliwangi.ac.id/" target="_blank" class="text-dark-75 text-hover-primary">poliwangi.ac.id</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<!--end::Nav-->
		...
		@livewireScripts
		<script defer src="{{ asset('vendor/node_modules/alpinejs/dist/cdn.min.js') }}"></script>
		<!--end::Scrolltop-->
		...
		<script src="{{ asset('assets-admin/plugins/custom/gmaps/gmaps.js') }}"></script>
		<!--end::Page Vendors-->
